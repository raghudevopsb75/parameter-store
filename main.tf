...
variable "parameters" {
  default = [
    ...
    { name = "dev.roboshop.user.REDIS_HOST", value = "dev-elasticache-001.dev-elasticache.nud0cy.use1.cache.amazonaws.com", type = "String" },
    { name = "dev.roboshop.cart.REDIS_HOST", value = "dev-elasticache-001.dev-elasticache.nud0cy.use1.cache.amazonaws.com", type = "String" },
