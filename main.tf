...
variable "parameters" {
  default = [
    ...
    { name = "prod.roboshop.frontend.catalogue_url", value = "http://catalogue-prod.rdevopsb73.online:80/", type = "String" },
    { name = "prod.roboshop.frontend.cart_url", value = "http://cart-prod.rdevopsb73.online:80/", type = "String" },
    ...
    { name = "prod.roboshop.shipping.CART_ENDPOINT", value = "cart-prod.rdevopsb73.online:80", type = "String" },
    { name = "prod.roboshop.payment.CART_HOST", value = "cart-prod.rdevopsb73.online", type = "String" },
    { name = "prod.roboshop.payment.CART_PORT", value = "80", type = "String" },
    { name = "prod.roboshop.payment.USER_HOST", value = "user-prod.rdevopsb73.online", type = "String" },
    { name = "prod.roboshop.payment.USER_PORT", value = "80", type = "String" },
    { name = "prod.roboshop.payment.AMQP_HOST", value = "rabbitmq-prod.rdevopsb73.online", type = "String" },
    { name = "prod.roboshop.payment.AMQP_USER", value = "roboshop", type = "String" },
    { name = "prod.roboshop.dispatch.AMQP_HOST", value = "rabbitmq-prod.rdevopsb73.online", type = "String" },
    { name = "prod.roboshop.dispatch.AMQP_USER", value = "roboshop", type = "String" },

    ## DB Endpoints
    { name = "prod.roboshop.docdb.endpoint", value = "prod-docdb-cluster.cluster-cbvsbeoyxek4.us-east-1.docdb.amazonaws.com", type = "String" },
    { name = "prod.roboshop.rds.endpoint", value = "prod-mysql.cluster-cbvsbeoyxek4.us-east-1.rds.amazonaws.com", type = "String" },
